        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url("admin/$uri/$row->id/edit") }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="sort_number" id="sort_number"
                                                ...
                                                value="{{ old('sort_number', $row->sort_number) }}" placeholder="Judul Postingan" autocomplete="off">
                                            @error('title')
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" id="name" name="name"
                                                ...
                                                value="{{ old('name', $row->name) }}" placeholder="Cth: John" autocomplete="off">
                                            @error('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <img id="target" src="{{ $row->image  ? asset("candidate/$row->image") : asset('assets/images/user.jpeg')}}"
